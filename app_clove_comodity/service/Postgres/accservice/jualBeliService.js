...
//SERVICE CUD jual beli
  ...
  async setVerifikasi(owner_user_as, id ,value) {
    console.log(owner_user_as, id ,value)
    const query ={
      text :`UPDATE jual_beli SET verifikasi_non_author= $1 WHERE id = $2 AND owner_user_as = $3 RETURNING id`,
