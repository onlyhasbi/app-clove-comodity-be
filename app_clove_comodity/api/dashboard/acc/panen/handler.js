...
async addHasilPanenHandler(request, h) {
  try {
    ...
    const response = await this._response( h, 201,  { hasilPanenId, }, `hasil panen berhasil ditambahkan`);
    return response;
  } 
  catch (error) {
    const response = await responseCatch(error, h);
...
async editHasilPanenHandler(request, h) {
  try {
    ...
    const response = await this._response(h, 201, { hasilPanenId } , 'Data hasil panen berhasil diubah');
    return response;
  }
  catch (error) {
    const response = await responseCatch(error, h);
...
async deleteHasilPanenHandler(request, h) {
  try {
    ...
    const response = await this._response(h, 201, undefined , 'Data hasil panen berhasil dihapus');
    return response;
  } 
  catch (error) {
    const response = await responseCatch(error, h);
...
async editSetoranHandler(request, h) {
  try {
    ...
    const response = await this._response(h, 201, { lahanId } , 'Data setoran berhasil diubah');
    return response;
  }
  catch (error) {
    const response = await responseCatch(error, h);
...
async deleteSetoranHandler(request, h) {
  try {
    ...
    const response = await this._response(h, 201, undefined , 'Data setoran berhasil dihapus');
    return response;
  } 
  catch (error) {
    const response = await responseCatch(error, h);
